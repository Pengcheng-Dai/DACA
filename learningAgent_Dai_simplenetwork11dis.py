    ...
    def episode(self, rate_w, rate_zeta=0):
        ...
        for i in range(self.agent_num):
            for t in range(self.horizon-1):
                ...
                # print("Q1", np.dot(phi_1, w))
                # print("Q2", np.dot(phi_2, w))
...
# ####################################################################################
    ...
    # 保存数据
    # np.save("./simple_network11/objective_perform_disnew_{}.npy".format(t_seed), Dis_objective_perform)

    # 画图
    # plt.figure()
    # plt.plot(Dis_objective_perform)
    # plt.savefig("./simple_network/one_bridge_dis.pdf")
    # plt.savefig("./simple_network/one_bridge_dis.png")
